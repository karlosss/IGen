...
void mm256_add_pd_opt_verify(){
    ...
    ddi_4 a3 = _igen_dd_op_mm256_load_pd(in_ddi+12);
    ddi_4 a4 = _igen_dd_op_mm256_load_pd(in_ddi+16);
    ddi_4 a5 = _igen_dd_op_mm256_load_pd(in_ddi+20);
    ddi_4 a6 = _igen_dd_op_mm256_load_pd(in_ddi+24);
    ddi_4 a7 = _igen_dd_op_mm256_load_pd(in_ddi+28);
    ddi_4 a8 = _igen_dd_op_mm256_load_pd(in_ddi+32);
    ddi_4 a9 = _igen_dd_op_mm256_load_pd(in_ddi+36);
    ddi_4 a10 = _igen_dd_op_mm256_load_pd(in_ddi+40);
    ddi_4 a11 = _igen_dd_op_mm256_load_pd(in_ddi+44);
    ddi_4 a12 = _igen_dd_op_mm256_load_pd(in_ddi+48);
    ddi_4 a13 = _igen_dd_op_mm256_load_pd(in_ddi+52);
    ddi_4 a14 = _igen_dd_op_mm256_load_pd(in_ddi+56);
    ddi_4 a15 = _igen_dd_op_mm256_load_pd(in_ddi+60);

    ddi_4 b0 = _igen_dd_op_mm256_load_pd(in_ddi+100);
    ddi_4 b1 = _igen_dd_op_mm256_load_pd(in_ddi+104);
    ddi_4 b2 = _igen_dd_op_mm256_load_pd(in_ddi+108);
    ddi_4 b3 = _igen_dd_op_mm256_load_pd(in_ddi+112);
    ddi_4 b4 = _igen_dd_op_mm256_load_pd(in_ddi+116);
    ddi_4 b5 = _igen_dd_op_mm256_load_pd(in_ddi+120);
    ddi_4 b6 = _igen_dd_op_mm256_load_pd(in_ddi+124);
    ddi_4 b7 = _igen_dd_op_mm256_load_pd(in_ddi+128);
    ddi_4 b8 = _igen_dd_op_mm256_load_pd(in_ddi+132);
    ddi_4 b9 = _igen_dd_op_mm256_load_pd(in_ddi+136);
    ddi_4 b10 = _igen_dd_op_mm256_load_pd(in_ddi+140);
    ddi_4 b11 = _igen_dd_op_mm256_load_pd(in_ddi+144);
    ddi_4 b12 = _igen_dd_op_mm256_load_pd(in_ddi+148);
    ddi_4 b13 = _igen_dd_op_mm256_load_pd(in_ddi+152);
    ...
    _igen_dd_op_mm256_store_pd(out_ddi+208, res2);
    _igen_dd_op_mm256_store_pd(out_ddi+212, res3);
    _igen_dd_op_mm256_store_pd(out_ddi+216, res4);
    _igen_dd_op_mm256_store_pd(out_ddi+220, res5);
    _igen_dd_op_mm256_store_pd(out_ddi+224, res6);
    _igen_dd_op_mm256_store_pd(out_ddi+228, res7);
    _igen_dd_op_mm256_store_pd(out_ddi+232, res8);
    _igen_dd_op_mm256_store_pd(out_ddi+236, res9);
    _igen_dd_op_mm256_store_pd(out_ddi+240, res10);
    _igen_dd_op_mm256_store_pd(out_ddi+244, res11);
    _igen_dd_op_mm256_store_pd(out_ddi+248, res12);
    _igen_dd_op_mm256_store_pd(out_ddi+252, res13);
    _igen_dd_op_mm256_store_pd(out_ddi+256, res14);
