...
#define mm256_extractf128_pd_VERIFY(NAME) \
    static void mm256_extractf128_pd_ ## NAME ## _verify() { \
        ...
        \
        ddi_2 res0 = _igen_dd_ ## NAME ## _mm256_extractf128_pd(a0, 0); \
        ddi_2 res1 = _igen_dd_ ## NAME ## _mm256_extractf128_pd(a1, 1); \
        ddi_2 res2 = _igen_dd_ ## NAME ## _mm256_extractf128_pd(a2, 0); \
        ddi_2 res3 = _igen_dd_ ## NAME ## _mm256_extractf128_pd(a3, 1); \
        \
        _igen_dd_fb_mm_store_pd(out_ddi+2048, res0); \
        _igen_dd_fb_mm_store_pd(out_ddi+2050, res1); \
        _igen_dd_fb_mm_store_pd(out_ddi+2052, res2); \
        _igen_dd_fb_mm_store_pd(out_ddi+2054, res3); \
    }

#define mm256_extractf128_pd_LAT(NAME) \
    static void mm256_extractf128_pd_ ## NAME ## _lat() { \
...
#define mm256_extractf128_pd_GAP(NAME) \
    static void mm256_extractf128_pd_ ## NAME ## _gap() { \
        for(int i = 0; i < BENCHMARK_ITER; ++i){ \
