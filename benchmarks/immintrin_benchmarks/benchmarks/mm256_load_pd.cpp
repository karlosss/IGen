...
void mm256_load_pd_base(double* in, double* out){
    ...
    _mm256_store_pd(out+100, a0);
    _mm256_store_pd(out+104, a1);
    _mm256_store_pd(out+108, a2);
    _mm256_store_pd(out+112, a3);
}
...
void mm256_load_pd_verify(dd_I* in, dd_I* out){
    ...
    _igen_dd_mm256_store_pd(out+100, a0);
    _igen_dd_mm256_store_pd(out+104, a1);
    _igen_dd_mm256_store_pd(out+108, a2);
    _igen_dd_mm256_store_pd(out+112, a3);
}
