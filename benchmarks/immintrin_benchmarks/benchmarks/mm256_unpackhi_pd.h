...
#define mm256_unpackhi_pd_VERIFY(NAME) \
    static void mm256_unpackhi_pd_ ## NAME ## _verify() { \
        ...
        ddi_4 b15 = _igen_dd_fb_mm256_load_pd(in_ddi+160); \
                                                       \
        ddi_4 res0 = _igen_dd_ ## NAME ## _mm256_unpackhi_pd(a0, b0); \
        ddi_4 res1 = _igen_dd_ ## NAME ## _mm256_unpackhi_pd(a1, b1); \
        ddi_4 res2 = _igen_dd_ ## NAME ## _mm256_unpackhi_pd(a2, b2); \
        ddi_4 res3 = _igen_dd_ ## NAME ## _mm256_unpackhi_pd(a3, b3); \
        ddi_4 res4 = _igen_dd_ ## NAME ## _mm256_unpackhi_pd(a4, b4); \
        ddi_4 res5 = _igen_dd_ ## NAME ## _mm256_unpackhi_pd(a5, b5); \
        ddi_4 res6 = _igen_dd_ ## NAME ## _mm256_unpackhi_pd(a6, b6); \
        ddi_4 res7 = _igen_dd_ ## NAME ## _mm256_unpackhi_pd(a7, b7); \
        ddi_4 res8 = _igen_dd_ ## NAME ## _mm256_unpackhi_pd(a8, b8); \
        ddi_4 res9 = _igen_dd_ ## NAME ## _mm256_unpackhi_pd(a9, b9); \
        ddi_4 res10 = _igen_dd_ ## NAME ## _mm256_unpackhi_pd(a10, b10); \
        ddi_4 res11 = _igen_dd_ ## NAME ## _mm256_unpackhi_pd(a11, b11); \
        ddi_4 res12 = _igen_dd_ ## NAME ## _mm256_unpackhi_pd(a12, b12); \
        ddi_4 res13 = _igen_dd_ ## NAME ## _mm256_unpackhi_pd(a13, b13); \
        ddi_4 res14 = _igen_dd_ ## NAME ## _mm256_unpackhi_pd(a14, b14); \
        ddi_4 res15 = _igen_dd_ ## NAME ## _mm256_unpackhi_pd(a15, b15); \
                                                       \
...
#define mm256_unpackhi_pd_LAT(NAME) \
    static void mm256_unpackhi_pd_ ## NAME ## _lat() { \
...
#define mm256_unpackhi_pd_GAP(NAME) \
    static void mm256_unpackhi_pd_ ## NAME ## _gap() { \
        for(int i = 0; i < BENCHMARK_ITER; ++i){ \
